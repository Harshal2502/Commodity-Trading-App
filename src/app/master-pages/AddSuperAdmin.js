...
import { ADD_ADMIN, ADD_SUPERADMIN } from '../../utils/API';
...
export const AddSuperAdmin = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const res = await ADD_SUPERADMIN(formData, username);
                ...
                <div className="col-md-6 grid-margin stretch-card ">
                    <div className="card ">
                        <div className="card-body">
                            <h4 className="card-title" >Register a New SuperAdmin</h4>
