    ...
    <div>
        ...
        <div className="card">
          <div className="card-body">
            ...
            <option value="admin4">Admin 4</option>
              ...
              <select onChange={(e) => { const value = e.target.value; setClient(value); }} class="form-control mb-2 mr-sm-2 col-md-10 col-lg-6 col-xl-3" >
      ...
      <div className="row">
        ...
        <div className="col-lg-12 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              <h4 className="card-title">PortFolio (0)</h4>
