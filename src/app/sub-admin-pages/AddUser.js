            ...
            <div className="card-body">
              ...
              <form className="forms-sample">
                ...
                <Form.Group>
                  ...
                  <select name='MCX_allow' value={formData.MCX_allow} onChange={handleInputChange} class="form-control">
                ...
                <Form.Group>
                  ...
                  <select name='FONSE_allow' value={formData.FONSE_allow} onChange={handleInputChange} class="form-control">
                ...
                <Form.Group>
                  ...
                  <select disabled={disabled} name='brokereage_MCX' value={formData.brokereage_MCX} onChange={handleInputChange} class="form-control">
                ...
                <Form.Group>
                  ...
                  <select disabled={disabled2} name='brokereage_NFO' value={formData.brokereage_NFO} onChange={handleInputChange} class="form-control">
                ...
                {/* <Form.Group>
                  <label htmlFor="exampleInputEmail1">Brokerage For MCX (0-10 Paisa)</label>
                  <Form.Control disabled={disabled} name='brokereage_MCX' value={formData.brokereage_MCX} onChange={handleInputChange} type="text" className="form-control" id="exampleInputEmail1" placeholder="Brokerage For MCX" />
                </Form.Group>

                <Form.Group>
                  <label htmlFor="exampleInputEmail1">Brokerage For NFO (0-10 Paisa)</label>
                  <Form.Control disabled={disabled2} name='brokereage_NFO' value={formData.brokereage_NFO} onChange={handleInputChange} type="text" className="form-control" id="exampleInputEmail1" placeholder="Brokerage For NFO" />
                </Form.Group> */}

                <Form.Group>
                  <label htmlFor="exampleInputConfirmPassword1">Profit Limit of User...! (0 = No Limit)</label>
                  <Form.Control name='profit_limit' value={formData.profit_limit} onChange={handleInputChange} type="number" className="form-control" id="exampleInputConfirmPassword1" placeholder="0" />
                </Form.Group>
                <Form.Group>
                  <label htmlFor="exampleInputConfirmPassword1">Margin Limit (X)</label>
                  <Form.Control name='margin_limit' value={formData.margin_limit} onChange={handleInputChange} type="number" className="form-control" id="exampleInputConfirmPassword1" placeholder="500" />
                </Form.Group>
